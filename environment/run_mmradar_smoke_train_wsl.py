...
EXPERIMENTS = [
    ...
    Experiment("InterFusion_aiqii", "pcdet", "InterFusion", "InterFusion", "cfgs/mmradar_models/interfusion_aiqii_smoke.yaml", "aiQiiDataset", "smoke_aiqii_v1"),
    Experiment("InterFusion_mmaud", "pcdet", "InterFusion", "InterFusion", "cfgs/mmradar_models/interfusion_mmaud_smoke.yaml", "mmaud", "smoke_mmaud_v1"),
    Experiment("PFANet_aiqii", "pcdet", "PFA-NET", "PFANet", "cfgs/mmradar_models/pfanet_aiqii_smoke.yaml", "aiQiiDataset", "smoke_aiqii_v1"),
    Experiment("PFANet_mmaud", "pcdet", "PFA-NET", "PFANet", "cfgs/mmradar_models/pfanet_mmaud_smoke.yaml", "mmaud", "smoke_mmaud_v1"),
