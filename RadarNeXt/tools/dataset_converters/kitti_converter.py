...
def _calculate_num_points_in_gt(data_path,
                                ...
                                remove_outside=True,
                                # num_features=4
                                # num_features=6 # for dual_radar
                                num_features=8  # jly for tj4d
                                ):
...
def create_kitti_info_file(data_path,
    ...
    test_img_ids = _read_imageset_file(str(imageset_folder / 'test.txt'))  # for tj4d
    # test_img_ids = _read_imageset_file(str(imageset_folder / 'val.txt'))  # temporally for dual radar
...
def _create_reduced_point_cloud(data_path,
                                ...
                                # num_features = 6, # jly for dual radar
                                num_features = 8, # jly for tj4d
                                front_camera_id=2):
