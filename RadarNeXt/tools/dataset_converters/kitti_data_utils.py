...
def get_image_index_str(img_idx, use_prefix_id=False):
    if use_prefix_id:
        ...
        return '{:06d}'.format(img_idx) # for dual_radar and tj4d
        # zrx for vod
...
def get_kitti_info_path(idx,
    ...
    if training:
        ...
        file_path = Path('training') / info_type / img_idx_str  # jly for tj4d
...
def get_image_path(idx,
                   ...
                   exist_check=True,
                   info_type='image_2',
                   file_tail='.png', # for dual_radar and tj4d
                   # file_tail='.jpg', # zrx for vod
                   use_prefix_id=False):
...
def get_velodyne_path(idx,
    ...
    return get_kitti_info_path(idx, prefix, 'velodyne', '.bin', training,
                                relative_path, exist_check, use_prefix_id)  # for dual radar lidar
    # return get_kitti_info_path(idx, prefix, 'radar_arbe', '.bin', training,
    #                             relative_path, exist_check, use_prefix_id)  # for arbe radar
    # return get_kitti_info_path(idx, prefix, 'radar_ars548', '.bin', training,
    #                            relative_path, exist_check, use_prefix_id) # for ars548 radar
...
def get_kitti_image_info(path,
    ...
    def map_func(idx):
        ...
        # pc_info = {'num_features': 6} # for dual_radar
        # pc_info = {'num_features': 7} # for vod
        pc_info = {'num_features': 8} # for tj4d
        calib_info = {}
