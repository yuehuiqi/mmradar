...
def create_groundtruth_database(dataset_class_name,
    ...
    if dataset_class_name == 'KittiDataset':
        ...
        dataset_cfg.update(
            ...
            # data_prefix=dict(
            #     pts='training/velodyne_reduced', img='training/image_2'),  # for processed point clouds
            data_prefix=dict(
                pts='training/velodyne', img='training/image_2'),  # for dual radar LiDAR and for tj4d radar
            # data_prefix=dict(
            #       pts='training/radar_arbe', img='training/image_2'),  # for dual radar arbe radar
            # data_prefix=dict(
            #     pts='training/radar_ars548', img='training/image_2'),  # for dual ars548 radar
            pipeline=[
                dict(
                    type='LoadPointsFromFile',
                    coord_type='LIDAR',
                    # load_dim=4,
                    # load_dim = 6, # for dual radar
                    # load_dim=7, # zrx for vod
                    load_dim=8, # jly for tj4d
                    # use_dim=6,
                    # use_dim=7, # zrx for vod
                    use_dim=8, # jly for tj4d
