...
class Pack3DDetInputs(BaseTransform):
    ...
    def pack_single_results(self, results: dict) -> dict:
        ...
        # packed_results: dict = {'data_sample': Det3DDataSample = __init__(box_mode_3d=<Box3DMode.LIDAR: 0>,
        #                                                                   cam2img: Transformation Matrix,
        #                                                                   gt_instances_3d = __init__(bboxes_3d: bboxes_gts = LiDARInstance3DBoxes(),
        #                                                                                              labels_3d: tensor = class annotations of bboxes), 
        #                                                                   img_path: path to relative image sample,
        #                                                                   lidar2cam: Transformation Matrix,
        #                                                                   lidar2img: Transformation Matrix
        #                                                                   lidar_path: path to relative point cloud sample,
        #                                                                   num_pts_feats: feature numbers of points,
        #                                                                   sample_idx: sample id in current train/val/test set),
        #                         'inputs': dict = {'points': tensor = points in the point cloud}}
