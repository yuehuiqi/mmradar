...
from mmdet3d.structures import DualRadarCameraInstance3DBoxes
from .det3d_dataset import Det3DDataset

#  新增：使用新的旋转角变化模式处理Dual Radar数据集的真值
@DATASETS.register_module()
class DualRadarDataset(Det3DDataset):
    r"""KITTI Dataset.
    ...
    def parse_ann_info(self, info: dict) -> dict:
        ...
        gt_bboxes_3d = DualRadarCameraInstance3DBoxes(
