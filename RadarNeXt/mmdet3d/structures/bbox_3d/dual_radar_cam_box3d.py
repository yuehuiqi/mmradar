...
class DualRadarCameraInstance3DBoxes(BaseInstance3DBoxes):
    ...
    def convert_to(self,
        ...
        Returns:
            ...
            the ``dst`` mode.
        """
        # 修改：使用按照Dual Radar的LiDAR坐标系修改后的旋转角变换模块进行坐标系的转换
        from .dual_radar_box_3d_mode import DualRadarBox3DMode

        # TODO: always set correct_yaw=True
        return DualRadarBox3DMode.convert(
            box=self,
            src=DualRadarBox3DMode.CAM,
            dst=dst,
            rt_mat=rt_mat,
