...
class Base3DDetector(BaseDetector):
    ...
    def forward(self,
        ...
        """
        if mode == 'loss':
            return self.loss(inputs, data_samples, **kwargs)  # inputs inherits from the 'inputs' of dictionary returned by Det3DDataPreprocessor's data_preprocessing pipeline
                                                              # data_samples inherits from the 'data_samples' of dictionary returned by Det3DDataPreprocessor's data_preprocessing pipeline
        elif mode == 'predict':
