...
# generate gaussian heatmap to supervise the center and corners classification
def draw_heatmap_gaussian(heatmap: Tensor,
    ...
    masked_heatmap = heatmap[y - top:y + bottom, x - left:x + right]  # filter the heatmap to keep it only inside the bbox
...
# generate gaussian heatmap radius for heatmap generation
