    ...
    def simple_process(self, data: dict, training: bool = False) -> dict:
        ...
        if 'points' in inputs:
            ...
            if self.voxel:
                ...
                batch_inputs['voxels'] = voxel_dict     # batch_inputs: dict = {'points': raw features of points, 
                                                        #                       'voxels': dict = {'voxels': features of points in each voxel,
                                                        #                                         'coors': the coordinate of non-empty voxels in voxel grid}}
                                                        #                                         'coors' = (batch_size, height_indices, h_indices, w_indices), h -> horizon(y-axis), w -> forward(x-axis)
