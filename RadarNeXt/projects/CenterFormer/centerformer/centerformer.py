...
class CenterFormer(Base3DDetector):
    ...
    def _forward(self, batch_inputs_dict, batch_data_samples):
        ...
        pts_feats = self.extract_feat(batch_inputs_dict, batch_input_metas)   # batch_inputs_dict = inputs; batch_input_metas = batch_data_samples['lidar_path'] = data_samples['lidar_path']
