...
class PillarNeXtCenterHead(nn.Module):
    def __init__(
            self,
            in_channels,
            tasks,
        ...
        super(PillarNeXtCenterHead, self).__init__()
        ...
        for (num_cls, stride) in zip(num_classes, strides):
            ...
            if with_corner and self.training:
        ...
        logger.info('Finish PillarNeXtCenterHeadIoUdIoU Initialization')
