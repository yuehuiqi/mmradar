...
from projects.PillarNeXt.pillarnext.utils.iou3d_nms_utils import boxes_iou3d_gpu, boxes_aligned_iou3d_gpu
...
class IouLoss(nn.Module):
    ...
    def forward(self, iou_pred, mask, ind, box_pred, box_gt):
        ...
        # target = boxes_iou3d_gpu(pred_box[mask], box_gt[mask])  # by jly
        target = 2 * target - 1
