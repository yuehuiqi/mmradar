from pillarnet_aiqii_smoke import *  # noqa: F401,F403

tasks = [dict(stride=8, class_names=["Air3S", "Mini4pro", "Mavic3Pro", "jingling4"])]
...
work_dir = "./work_dirs/mmradar_pillarnet_aiqii_multiclass_smoke"
